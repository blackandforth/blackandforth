...
const SkillsDevelopment = () => {
  return (
    <section className="bg-gray-100 py-16 px-6 md:px-20 text-center">
      ...
      {/* Skills Content */}
      <div className="mt-10 bg-white shadow-md rounded-lg p-8 max-w-5xl mx-auto grid md:grid-cols-2 gap-8 text-left">
        {/* Technology Skills */}
        <div>
      ...
      {/* Button */}
      <div className="mt-10">
        <button className="bg-teal-600 text-white px-8 py-3 rounded-full shadow-md hover:bg-teal-700 transition">
          FIND OUT MORE
        </button>
      </div>
    </section>
